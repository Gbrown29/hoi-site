...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
  ...
  <div style="background-color: #f8f8f8; padding: 20px; text-align: center;">
    <img src="./assets/images/logo/black%20logo.png" alt="House of India Logo" style="max-width: 200px;">
      ...
      ${cart
        ...
        <tr>
          <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">
            <img src="${item.image || './assess/images/${item.category}/${item.name}.png/'}" alt="${item.name}" style="max-width: 60px; border-radius: 4px;">
          </td>
